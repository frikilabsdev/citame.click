...
// Social media platform icons - Open source SVG icons
// These are based on official brand guidelines and open source implementations
...
export const OnlyFansIcon = ({ className = "w-5 h-5" }: { className?: string }) => (
  <svg className={className} viewBox="0 0 24 24" fill="currentColor">
...
export const getSocialIcon = (platform: string): React.ComponentType<{ className?: string }> => {
  ...
  return iconMap[platform.toLowerCase()] || (() => <div className="w-5 h-5 rounded-full bg-slate-300" />);
};
